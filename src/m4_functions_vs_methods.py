...
def try_methods():
    ...
    Then makes the SimpleTurtle move as follows (in the order listed):
      ...
      -- backward  100 units
    """
    turtle111 = rg.SimpleTurtle()
    turtle111.pen = rg.Pen('brown', 5)
    turtle111.forward(150)
    turtle111.left(90)
    turtle111.forward(50)
    turtle111.backward(100)
    ###########################################################################
...
def try_methods_and_functions():
    ...
    turtle222 = rg.SimpleTurtle()
    turtle222.pen = rg.Pen('blue', 5)
    turtle222.backward(150)
    turtle222.speed = 1
    draw_many_squares(turtle222, 2, 100, 30)
    turtle222.speed = 5
    turtle222.pen.color = 'red'
    draw_many_squares(turtle222, 10, 50, 15)
    turtle222.speed = 100
    turtle222.pen.thickness = 35
    draw_many_squares(turtle222, 8, 300, 60)
    turtle222.pen = rg.Pen('black', 3)
    turtle222.backward(200)
    turtle222.draw_circle(30)
    turtle222.draw_square(50)
    ###########################################################################
